class LoanOrigin:
    ...
    def __init__(self, credit_sum: str, interest_rate: str, periods: str):
        ...
        """
        self.__credit_sum = float(credit_sum)  # Преобразуем строку в число с плавающей точкой для суммы кредита
        self.__interest_rate = float(interest_rate) / 100  # Преобразуем строку в процентную ставку в долях (например, 5% -> 0.05)
        self.__periods = int(periods)  # Преобразуем строку в целое число для срока кредита в месяцах
